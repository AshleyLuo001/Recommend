...
os.system('python ./code/feature_user_item_last5.py '+all_path+' & python ./code/feature_user.py '+all_path+' & python ./code/feature_category.py '+all_path+' & (python ./code/test_label.py '+two_path+' && ( (python ./code/merge_user_item_cnt.py '+two_path+' && (python ./code/feature_item.py '+all_path+' & python ./code/feature_user_item_part2.py '+all_path+' & wait)) & (python ./code/merge_user_item_time.py '+two_path+' && python ./code/feature_user_item_part1.py '+all_path+') & wait)) & (python ./code/test_label_category.py '+all_path+' && ( (python ./code/merge_user_category_time.py '+output_path+' && python ./code/feature_user_category_part1.py '+all_path+') & (python ./code/merge_user_category_cnt.py '+output_path+' && python ./code/feature_user_category_part2.py '+all_path+') & wait)) & wait')
...
tmp_list=[]
for i in range(50):
    tmp_str='python ./code/infer_part2.py ' + feature_path+' '+str(i)
    tmp_list.append(tmp_str)
os.system(' & '.join(tmp_list)+' & wait')
os.system('python ./code/infer_part3.py ' + feature_path)
print('-' * 20, '推理完成', '-' * 20)
t4 = time.time()
